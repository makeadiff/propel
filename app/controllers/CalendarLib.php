 ...
 *	}
 */
class CalendarLib extends BaseController{
    public $month;
    public $year;
    public $limit;
    ...
    private function _each_day() {
        ...
        if(is_callable($this->_callback_cell_class_provider) and $flag) {
            ...
            $class .= $func($this->year, $curmonth, $da, $weekdays[($column%7)]);
        }
        ...
        if($flag) {
            ...
            if(is_callable($this->_callback)) {
                $func = $this->_callback;
                $func($this->year, $curmonth, $da, $weekdays[($column%7)] );
            }
            print "</div>";
    ...
    function printCalendarNavigationLinks() {
        ...
        $last_month = date('F',mktime(0,0,0,$this->month-1,1,$this->year));
